...
int triangulate_wrapper(const PhiPoint * edgesLandMarks, int nEdges, int nFaces, int * nTris)
{
    ...
    in.numberofsegments = 27 + 2*6 + 9 + 8 + 12;
    in.segmentlist = (REAL *) malloc(in.numberofsegments * 2 * sizeof(REAL));
    ...
    {
        in.segmentlist[i] = *(double*)((int*)(edgesLandMarks) + 1);
    }
